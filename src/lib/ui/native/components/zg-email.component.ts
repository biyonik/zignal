...
@Component({
    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => ZgEmailComponent),
            multi: true,
        },
        {
    ...
    template: `
        <div class="zg-field zg-email-field" [class]="wrapperClass">
            ...
            <div class="zg-input-wrapper" [class.has-prefix]="prefixText || prefixIcon" [class.has-suffix]="suffixText || suffixIcon">
                ...
                <input
                        ...
                        [name]="field().name"
                        [value]="value ?? ''"
                        [placeholder]="field().config.placeholder ?? 'example@email.com'"
                        [disabled]="disabledStatus"
                        [readonly]="readonly()"
                        [attr.autocomplete]="autocompleteValue ?? 'email'"
    ...
    styles: [`
        ...
        .zg-input-wrapper { display: flex; align-items: center; }
        ...
        .has-prefix .zg-input { border-radius: 0 6px 6px 0; }
        .has-suffix .zg-input { border-radius: 6px 0 0 6px; }
        .has-prefix.has-suffix .zg-input { border-radius: 0; }
        .zg-input:focus {
            outline: none;
            border-color: #3b82f6;
...
export class ZgEmailComponent extends BaseNativeComponent<EmailField, string> {
