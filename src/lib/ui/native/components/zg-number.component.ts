...
@Component({
    ...
    template: `
        <div class="zg-field zg-number-field" [class]="wrapperClass">
            ...
            <div class="zg-input-wrapper" [class.has-prefix]="prefixText || prefixIcon" [class.has-suffix]="suffixText || suffixIcon">
                ...
                <input
                        ...
                        [readonly]="readonly"
                        [min]="props?.min ?? field().config.min"
                        [max]="props?.max ?? field().config.max"
                        [step]="props?.step ?? field().config.step ?? (field().config.integer ? 1 : 'any')"
